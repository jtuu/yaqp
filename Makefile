...
DEPS := $(GEN_DEPS) ./src/areas.h ./src/bin.h ./src/bp.h ./src/dat.h ./src/items.h ./src/list.h ./src/mon.h ./src/obj.h ./src/qst.h ./src/asm.h ./src/disasm.h ./src/utils.h ./lib/include/PRS-decomp.h ./lib/include/psoarchive-error.h
SRC := ./lib/PRS-decomp.c ./src/bin.c ./src/dat.c ./src/list.c ./src/obj.c ./src/qst.c ./src/asm.c ./src/disasm.c ./src/utils.c ./src/yaqp.c
ODIR := obj
